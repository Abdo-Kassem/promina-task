...
@section('pageTitle') <i class="fas plus-circle"></i> Create Album @endsection
...
<div class="box">
    ...
    <div class="box-body">
        ...
        <form id="myForm" action="{{ route('albums.store') }}" method="POST" class="userForm" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        <button type="submit" class="btn btn-success btn-block w-100" style="font-size:16px"><i class="fa fa-check fa-fw fa-lg"></i> Save</button>
                    </div>
                </div>
